...
Pane {
    ...
    property color highlightColor: app.isDarkMode ? Qt.lighter(backgroundColor) : "#E0E0E0"
    property real footerHeight : root.units(50)
        ...
        states: [
            State {
                ...
                PropertyChanges {
                    ...
                    backgroundColor:app.isDarkMode ? Qt.darker("#f0f0f5") : "#E0E0E0" //root.highlightColor
                }
            }
        ]
